...
- Dedicated Synchronizers can also exist; the Global Synchronizer is **not required** for all Canton applications
...
- If suitable, move them to the "Dedicated Synchronizer" chapter.
