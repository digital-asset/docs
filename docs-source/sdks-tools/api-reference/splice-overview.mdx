...
- Review the summary of the [Canton Network tokenomics](/overview/reference/canton-coin-tokenomics).
- Learn to build Canton Network applications from the tutorials, how-tos, explanations, and reference documentation at [Choose Your Path](/appdev/get-started/choose-your-path)
