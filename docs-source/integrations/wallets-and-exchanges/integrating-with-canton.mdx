---
title: 'Integrating with the Canton Network'
description: 'Necessary and optional features for integrating a wallet, hosting a validator, and connecting to a synchronizer.'
---
