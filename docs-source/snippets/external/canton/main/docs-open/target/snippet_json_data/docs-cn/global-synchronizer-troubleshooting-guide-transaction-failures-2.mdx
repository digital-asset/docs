    ...
    res3: Seq[com.digitalasset.canton.admin.api.client.data.topology.ListVettedPackagesResult] = Vector(
      ListVettedPackagesResult(
        context = BaseResult(
          ...
          validFrom = 2026-06-30T12:43:39.314058Z,
          validUntil = None,
          sequenced = 2026-06-30T12:43:39.064058Z,
          operation = Replace,
          transactionHash = TxHash(hash = SHA-256:aea35307e95c...),
...
@ participant1.packages.list().filter(_.packageId.toString.nonEmpty)
    res4: Seq[PackageDescription] = Vector(
      PackageDescription(
        ...
        version = 1.0.0,
        uploadedAt = 2026-06-30T12:43:29.332399Z,
        size = 114
      ),
      PackageDescription(
      ...
      PackageDescription(
        ...
        name = daml-prim,
        version = 0.0.0,
        uploadedAt = 2026-06-30T12:43:40.200566Z,
        size = 286794
      ),
      PackageDescription(
