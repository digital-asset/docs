...
@ participant.synchronizers.list_registered()
    res5: Seq[(SynchronizerConnectionConfig, com.digitalasset.canton.admin.api.client.data.ConfiguredPhysicalSynchronizerId, Boolean)] = Vector(
      (
        SynchronizerConnectionConfig(
          ...
          sequencerConnections = SequencerConnections(
            connections = Sequencer 'sequencer1' -> GrpcSequencerConnection(
              ...
              endpoints = http://127.0.0.1:30187
            ),
